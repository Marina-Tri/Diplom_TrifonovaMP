...
--
-- Хост: localhost
-- Время создания: Апр 04 2025 г., 20:22
...
INSERT INTO `Feedback` (`ID`, `ID_user`, `Message`, `Evaluation`) VALUES
(1, 2, 'Что-то', 10),
(2, 2, '', NULL),
(3, 2, '', NULL);
...
CREATE TABLE `Films` (
  ...
  `Age_Rating` varchar(4) DEFAULT NULL,
...
INSERT INTO `Request` (`ID`, `ID_user`, `Reason`, `Details`, `ID_status`) VALUES
(1, 2, 'Что-то', NULL, 1),
(2, 2, 'Что-то', '', 1),
(3, 2, 'Что-то', '', 1);
...
(2, 'Rin', 'Трифонова Марина Павловна', 2, 21, 'c31d493fe33a8c75f971808fdb259df6436556d81a1ad36b897dcd96', 1072951964, 4, NULL),
...
(15, 'log1', 'Кто-то', 2, 20, 'c31d493fe33a8c75f971808fdb259df6436556d81a1ad36b897dcd96', NULL, 1, 'djjgj@fgh.ru'),
(18, 'log2', 'Кто-то', 1, 20, 'e09d5852873e0c123e827cae942a5ee6b85f48065ac9685ed499f52b', NULL, 1, 'djjgjqw@fgh.ru');
